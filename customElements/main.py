...
async def getColumns():
    ...
    rowStyles = [
            { "code": """ getField("electric") """, "style" : """ { "background-color": "yellow" } """},
            { "code": """ getField("model") == "Model Y" """, "style" : """ { "background-color": "gray" } """},
    ]
...
data = [
      ...
      { 'id': 3, 'make': "cdToyota", 'model': "Corolla",  'price': 29600, 'electric': False },
      { 'id': 4, 'make': "cdTesla",  'model': "Model Y2",  'price': 64950, 'electric': True },
      { 'id': 5, 'make': "cdFord",   'model': "F-Series2", 'price': 33850, 'electric': True },
      { 'id': 6, 'make': "cdToyota", 'model': "Corolla2",  'price': 29600, 'electric': True },
    ]
